    ...
    public static void  TestSendEmail(){
        ...
        Session session = Session.getDefaultInstance(props, new javax.mail.Authenticator() {
            ...
            protected PasswordAuthentication getPasswordAuthentication() {
                ...
                return new PasswordAuthentication("18811561684@163.com", "hzy19920615");
        ...
        try {
            ...
            // 设置发件人邮箱地址
            message.setFrom(new InternetAddress("18811561684@163.com"));

            // 设置收件人邮箱地址
            message.setRecipients(Message.RecipientType.TO,InternetAddress.parse("2393325422@qq.com"));
            ...
            // 设置邮件中附件文件的路径
            String filename = "d:\\Web截图\\screenshot.png";
